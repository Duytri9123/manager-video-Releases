"""Shared DTRouter image-generation client.

DTRouter's `/v1/images/generations` endpoint returns **two different** response
...
def generate_images(
    ...
    *,
    ...
    try:
        ...
        return [], f"DTRouter unreachable: {exc}"
    ...
    try:
        if resp.status_code >= 400:
            ...
            return [], f"DTRouter HTTP {resp.status_code}: {str(msg)[:300]}"
        ...
        try:
            ...
            return [], "DTRouter returned an invalid JSON response"
